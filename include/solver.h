...
struct tissue{
	...
	std::vector<Vector3d> ip_sigma;
	std::vector<Vector3d> ip_sigma_act;
	std::vector<Vector3d> ip_sigma_pas;
	std::vector<int> ip_fiber;
	std::vector<double> ip_rhoi;
	std::vector<double> ip_fm;
	// boundary conditions
	//
	...
	// essential boundary conditions for moving edge, recording nodes
	...
	// material parameters
	std::string fiber_health;
	std::string fiber_wound;
